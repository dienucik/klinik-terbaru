...
<script src="https://code.highcharts.com/modules/export-data.js"></script>
        ...
        <hr>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Grafik Penggunaan Obat Pelayanan Dokter Umum</div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-2">
                  <a class="btn btn-warning right" href="<?=base_url()?>manajemen/cetak_obat_umum">Cetak</a>
                </div>
                <div class="col-md-8">
                  <div id="obat"></div>
                </div>
  ...
  var d = new Date();
  var n = d.getFullYear();
          var url = "<?=base_url('manajemen/getObatTahun/')?>"+n;
      $("#testt").load(url);
    function getTahun(data){
      var url = "<?=base_url('manajemen/getObatTahun/')?>"+data.value;
