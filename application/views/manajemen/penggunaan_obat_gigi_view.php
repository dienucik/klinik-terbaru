...
<script src="https://code.highcharts.com/modules/export-data.js"></script>
        ...
        <hr>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Grafik Penggunaan Obat Pelayanan Dokter Gigi</div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-2">
                  <a class="btn btn-warning right" href="<?=base_url()?>manajemen/cetak_obat_gigi">Cetak</a>
                </div>
                <div class="col-md-8">
                  <div id="obat_gigi"></div>
                </div>
              </div>
            </div>
          </div>
  ...
  var d = new Date();
  var n = d.getFullYear();
          var url = "<?=base_url('manajemen/getObatGigiTahun/')?>"+n;
      $("#testt").load(url);
    function getTahun(data){
      var url = "<?=base_url('manajemen/getObatGigiTahun/')?>"+data.value;
