        ...
        <hr>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Grafik Kunjungan Pasien Pelayanan Dokter Gigi</div>
            <div class="card-body">
            <a class="btn btn-warning right" href="<?=base_url()?>manajemen/cetak_kunjungan_gigi">Cetak</a>
            <div class="row">
              <div class="col-md-2"></div>
              <div class="col-md-8">
                <div id="kunjungan_gigi"></div>
              </div>
            </div>
