...
<script src="https://code.highcharts.com/modules/export-data.js"></script>
  ...
  <body id="page-top">
        ...
        <hr>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Grafik Kunjungan Pasien Pelayanan Dokter Umum</div>
            <div class="card-body">
            <a class="btn btn-warning right" href="<?=base_url()?>manajemen/cetak_kunjungan_umum">Cetak</a>
            <div class="row">
    ...
    sessionStorage.clear(); 
      var d = new Date();
      var n = d.getFullYear();
          var url = "<?=base_url('manajemen/getKunjunganPasienTahun/')?>"+n;
      $("#testt").load(url);
      function getTahun(data){
        var url = "<?=base_url('manajemen/getKunjunganPasienTahun/')?>"+data.value;
