  ...
  <body id="page-top">
    ...
    <div id="wrapper">
       ...
       <ul class="sidebar navbar-nav" style="background-color: #153d1f; font-size: 20px;">
            <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url();?>manajemen/index">
            ...
            <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url();?>manajemen/obat">
                <i class="fas fa-fw fa-chart-area" style="color: white"></i>
      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=site_url();?>manajemen/ganti_password" method="post">
             <div class="form-group">
                <label class="col-md-2 control-label" for="old">Password Lama</label>
                <div class="col-md-11">
                  <input class="form-control" type="password" name="old" id="old" value="<?= set_value('old'); ?>" required>
                </div>
              </div>
             <div class="form-group">
                <label class="col-md-2 control-label" for="new">Password Baru</label>
                <div class="col-md-11">
                  <input class="form-control" type="password" name="new" id="new" value="<?= set_value('new'); ?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="re_new">Ulangi Password</label>
                <div class="col-md-11">
                  <input class="form-control" type="password" name="re_new" id="re_new">
                </div>
              </div>
              </div>
              <br>
              ...
              <div class="text-center">
                    <button type="submit" class="btn btn-success register_btn " name="register">Simpan</button>
              </div>
            </form>
          </div>
        </div>
