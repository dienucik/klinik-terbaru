      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Form Pengkajian Awal Gigi 
          </div>
          <div class="card-body">
            <form action="<?=base_url()?>admin/periksaPasienGigiDb/" method="post">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-11">
                  <input class="form-control" type="text" name="alergi_makanan" id="alergi_makanan">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-11">
                  <div class="form-inline">
                    <input type="radio" name="golongan_darah" id="golongan_darah" value="A">A
                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="golongan_darah" id="golongan_darah" value="B">B
                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="golongan_darah" id="golongan_darah" value="AB">AB
                    &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="golongan_darah" id="golongan_darah" value="O">O
                  </div>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                ?>
                <input class="form-control" type="text" name="id_dokter" value="<?= $row->nama_dokter; ?>" readonly>
                <?php } ?>
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan menambah data pengkajian awal?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
