  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <h2>Data Dokter</h2>
        <hr>
        <a class="btn btn-warning" href="<?=base_url()?>admin/dokter">Kembali</a>  
        <br>
        <br>
        <?php 
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>admin/updateDokterDb/" method="post">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="col-md-6 control-label" for="waktu_mulai">Waktu Mulai</label>
                    <div class="col-md-10">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="col-md-6 control-label" for="waktu_selesai">Waktu Selesai</label>
                    <div class="col-md-10">
