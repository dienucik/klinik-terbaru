    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>admin/updatePasienDb/" method="post">
              ...
              <div class="form-group">
                ...
                <div class="radio col-md-11">
                   <input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="laki-laki" <?php if($detail->jenis_kelamin=='laki-laki') { ?> checked <?php } ?>>
                   <label for="jenis_kelamin">
                     Laki-Laki
                   </label>
                </div>
                <div class="radio col-md-11">
                  <input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="perempuan" <?php if($detail->jenis_kelamin=='perempuan') { ?> checked <?php } ?>>
                  <label for="jenis_kelamin">
                    Perempuan
                  </label>
                </div>
              ...
              <div class="form-group">
                ...
                <br>
                <div class="radio col-md-11">
                  <input type="radio" name="jenis_pasien" id="jenis_pasien" value="umum" <?php if($detail->jenis_pasien=='umum') { ?> checked <?php } ?>>
                  <label for="jenis_pasien">
                    Umum
                  </label>
                </div>
                <div class="radio col-md-11">
                  <input type="radio" name="jenis_pasien" id="jenis_pasien" value="BPJS" <?php if($detail->jenis_pasien=='BPJS') { ?> checked <?php } ?>>
                  <label for="jenis_pasien">
                    BPJS
                  </label>
                </div>
                <div class="radio col-md-11">
                  <input type="radio" name="jenis_pasien" id="jenis_pasien" value="PLN" <?php if($detail->jenis_pasien=='PLN') { ?> checked <?php } ?>>
                  <label for="jenis_pasien">
                    PLN
                  </label>
                </div>
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan mengedit data pasien?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
