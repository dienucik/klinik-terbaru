  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <?php 
           foreach($awal->result() as $detail){
        ?>
        <h2>Data Pengkajian Awal Dokter Umum</h2>
        <hr>
        <a class="btn btn-warning" href="<?=base_url()?>admin/periksa">Kembali</a>  
        <br>
        <br>
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>admin/updatePengkajianAwalDb/" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-md-11">
                  <input class="form-control" rows="3" name="alergi_obat" id="alergi_obat" value="<?= $detail->alergi_obat;?>">
                </div>
              </div>
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-5">
                    ...
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="number" min="0" max="500" name="berat_badan" id="berat_badan" value="<?= $detail->berat_badan;?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <label class="col-md-5 control-label" for="tinggi_badan" style="color: black">Tinggi Badan (cm)</label>
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="number" min="50" max="2700" name="tinggi_badan" id="tinggi_badan" value="<?= $detail->tinggi_badan;?>">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="number" min="15" max="45" name="suhu" id="suhu" value="<?= $detail->suhu;?>">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-4">
                    ...
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="number" min="0" max="300" name="kolesterol_tetap" id="kolesterol_tetap" value="<?= $detail->kolesterol_tetap;?>">
                    </div>
                  </div>
                  <div class="col-md-3">
                    <label class="col-md-9 control-label" for="gula_darah_sesaat" style="color: black">Gula Darah Sesaat (mg/dL)</label>
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="number" min="0" max="200" name="gula_darah_sesaat" id="gula_darah_sesaat" value="<?= $detail->gula_darah_sesaat;?>">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <label class="col-md-9 control-label" for="asam_urat" style="color: black">Asam Urat (mg/dL)</label>
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="number" min="0" max="9" name="asam_urat" id="asam_urat" value="<?= $detail->asam_urat;?>">
                    </div>
                  </div>
                </div>
              </div>
