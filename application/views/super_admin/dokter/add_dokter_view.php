    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/addDokterDb" method="post">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-11">
                  <input class="form-control" type="text" name="sip" id="sip" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama_dokter">Nama Dokter</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama_dokter" id="nama_dokter" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="col-md-5">
                    ...
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="time" name="waktu_mulai" id="waktu_mulai" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <label class="col-md-5 control-label" for="waktu_selesai">Waktu Selesai </label>
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="time" name="waktu_selesai" id="waktu_selesai" required>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan menambah data dokter?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
