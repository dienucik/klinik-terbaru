  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <h2>Data Dokter</h2>
        <hr>
        <a class="btn btn-warning" href="<?=base_url()?>super_admin/dokter">Kembali</a>  
        <br>
        <br>
        <?php 
          foreach($dokter->result() as $detail){
        ?>
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/updateDokterDb/" method="post">
              <div class="form-group">
                <label class="col-md-2 control-label" for="id_dokter"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" name="id_dokter" id="id_dokter"  value="<?= $detail->id_dokter;?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-md-2 control-label" for="sip">SIP</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="sip" id="sip" value="<?= $detail->sip;?>" >
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama_dokter">Nama Dokter</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama_dokter" id="nama_dokter" value="<?= $detail->nama_dokter;?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-md-2 control-label">Jadwal Pemeriksaan</label>
                <div class="form-row">
                  <div class="col-md-5">
                    <label class="col-md-5 control-label" for="waktu_mulai">Waktu Mulai</label>
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="time" name="waktu_mulai" id="waktu_mulai" value="<?= $detail->waktu_mulai;?>">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <label class="col-md-5 control-label" for="waktu_selesai">Waktu Selesai </label>
                    <div class="input-group mb-md col-md-12">
                      <input class="form-control" type="time" name="waktu_selesai" id="waktu_selesai" value="<?= $detail->waktu_selesai;?>">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan mengubah data dokter?')">Simpan</button>
              </div>
            </form>
            <?php } ?>
          </div>
