    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/addPenyakitDb" method="post">
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan menambah data penyakit?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
