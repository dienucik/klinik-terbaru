  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <h2>Data Penyakit</h2>
        <hr>
        <a class="btn btn-warning" href="<?=base_url()?>super_admin/penyakit">Kembali</a>  
        <br>
        <br>
        <?php 
          foreach($penyakit->result() as $detail){
        ?>
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/updatePenyakitDb/" method="post">
              <div class="form-group">
                <label class="col-md-2 control-label" for="id_penyakit"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" value="<?= $detail->id_penyakit;?>" name="id_penyakit" id="id_penyakit" >
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama_penyakit">Nama Penyakit</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" value="<?= $detail->nama_penyakit;?>" name="nama_penyakit" id="nama_penyakit">
                </div>
              </div>
              <br>
              <br>
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan mengubah data penyakit?')">Simpan</button>
              </div>
            </form>
            <?php } ?>
          </div>
