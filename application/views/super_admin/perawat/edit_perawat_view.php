  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <?php 
        foreach($perawat->result() as $detail){
    ?>
        <h2>Data Manajemen</h2>
        <hr>
        <a class="btn btn-warning" href="<?=base_url()?>super_admin/perawat">Kembali</a>  
        <br>
        <br>
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/updatePerawatDb/" method="post">
             <div class="form-group">
                <label class="col-md-2 control-label" for="id_perawat"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" name="id_perawat" id="id_perawat" value="<?= $detail->id_perawat;?>" >
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama_perawat">Nama Perawat</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama_perawat" id="nama_perawat" value="<?= $detail->nama_perawat;?>" >
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan mengubah data perawat?')">Simpan</button>
              </div>
            </form>
            <?php } ?>
          </div>
