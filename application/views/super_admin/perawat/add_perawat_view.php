    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/addPerawatDb" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama_perawat" id="nama_perawat" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan menambah data perawat?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
