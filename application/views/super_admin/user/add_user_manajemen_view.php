      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Form Tambah Akun Manajemen
          </div>
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/addUser3Db" method="post">
               <div class="form-group">
                <label class="col-md-2 control-label" for="id_manajemen"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" name="id_manajemen" id="id_manajemen" value="<?php echo $manajemen->id_manajemen; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama">Nama Manajemen</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama" id="nama" value="<?php echo $manajemen->nama_manajemen; ?>" readonly>
                </div>
              </div>
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-11">
                  <input class="form-control" type="text" name="level" id="level" value="manajemen" readonly>
                </div>
              </div>
              <br>
              <br>
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan menambah akun untuk manajemen?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
