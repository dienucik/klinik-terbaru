  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <h2>Data User</h2>
        <hr>
        <a class="btn btn-warning" href="<?=base_url()?>super_admin/index">Kembali</a> 
        <br>
        <br>
         <?php 
    ...
    ?>
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/updateUserDb" method="post">
               <div class="form-group">
                <label class="col-md-2 control-label" for="id_user"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" name="id_user" id="id_user" value="<?php echo $detail->id_user; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama">Nama</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama" id="nama" value="<?php echo $detail->nama; ?>" readonly>
                </div>
              </div>
             <div class="form-group">
                <label class="col-md-2 control-label" for="username">Username</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="username" id="username" value="<?= $detail->username;?>" readonly>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="level">Level</label>
                <div class="col-md-11">
                  <select type="text" class="form-control" name="level" id="level" value="<?= $detail->level;?>">
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan mengubah data user?')">Simpan</button>
              </div>
            </form>
            <?php } ?>
          </div>
