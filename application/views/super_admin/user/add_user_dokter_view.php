      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Form Tambah Akun Dokter
          </div>
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/addUserDb" method="post">
               <div class="form-group">
                <label class="col-md-2 control-label" for="id_dokter"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" name="id_dokter" id="id_dokter" value="<?php echo $dokter->id_dokter; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama">Nama Dokter</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama" id="nama" value="<?php echo $dokter->nama_dokter; ?>" readonly>
                </div>
              </div>
             <div class="form-group">
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan menambah akun untuk dokter?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
