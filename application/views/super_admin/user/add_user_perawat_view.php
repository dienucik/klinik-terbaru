      ...
      <div id="content-wrapper">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Form Tambah Akun Perawat
          </div>
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/addUser2Db" method="post">
               <div class="form-group">
                <label class="col-md-2 control-label" for="id_perawat"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" name="id_perawat" id="id_perawat" value="<?php echo $perawat->id_perawat; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama">Nama Perawat</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama" id="nama" value="<?php echo $perawat->nama_perawat; ?>" readonly>
                </div>
              </div>
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-11">
                  <input class="form-control" type="password" name="password" id="password" value="1234" readonly>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="level">Level</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="level" id="level" value="perawat" readonly>
                </div>
              </div>
              <br>
              <br>
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan menambah akun untuk perawat?')">Simpan</button>
              </div>
            </form>
          </div>
        </div>
