  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <h2>Data Obat</h2>
        <hr>
        <a class="btn btn-warning" href="<?=base_url()?>super_admin/obat">Kembali</a>  
        <br>
        <br>
        <?php 
          foreach($obat->result() as $detail){
        ?>
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="<?=base_url()?>super_admin/updateObatDb/" method="post">
              <div class="form-group">
                <label class="col-md-2 control-label" for="id_obat"></label>
                <div class="col-md-11">
                  <input class="form-control" type="hidden" value="<?= $detail->id_obat;?>" name="id_obat" id="id_obat" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="nama_obat">Nama Obat</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="nama_obat" id="nama_obat" value="<?= $detail->nama_obat;?>" >
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="stok_obat">Stok Obat</label>
                <div class="col-md-11">
                  <input class="form-control" type="text" name="stok_obat" id="stok_obat" value="<?= $detail->stok_obat;?>" >
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label" for="sediaan">Sediaan</label>
                <div class="col-md-11">
                  <select type="text" class="form-control" value="<?= $detail->stok_obat;?>" name="sediaan" id="sediaan">
              ...
              <div class="text-center">
                    <button class="btn btn-success register_btn " name="register" onclick="return confirm('Yakin akan mengubah data obat?')">Simpan</button>
              </div>
            </form>
            <?php } ?>
          </div>
